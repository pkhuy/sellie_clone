...
_signals = Namespace()
models_committed = _signals.signal('model-committed')
before_models_committed = _signals.signal('before-model-committed')
...
class BaseQuery(orm.Query):
    ...
    This is the default :attr:`~Model.query` object used for model, and exposed as :attr:`~SQLAlchemy.Query`.
...
class SQLAlchemy(object):
    ...
    def make_declarative_base(self, model, metadata=None):
        """Creates the declarative base that all model will inherit from.
